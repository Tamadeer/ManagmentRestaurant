...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">مرحبا بك في الداشبورد</h2>
    ...
    <div class="row row-sm">
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">عدد الطلبات المنفذة</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white" style="font-size: 30px !important;color: white;">
                                    {{\App\Models\Order::count()}}
                                </h4>
                                {{--                                <p class="mb-0 tx-12 text-white op-7">Compared to last week</p>--}}
                            </div>
                            <span class="float-right my-auto mr-auto">
											<i class="far fa-file-alt" style="font-size: 30px !important;color: white;"></i>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
											<i class="icon ion-ios-home" style="font-size: 30px;color: white;"></i>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">عدد المستخدمين
                        </h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
											<i class="mdi mdi-account-edit" style="font-size: 30px;color: white;"></i>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">عدد الزبائن</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white" style="font-size: 30px;color: white;">{{\App\Models\User::count()}}</h4>
                                {{--                                <p class="mb-0 tx-12 text-white op-7">Compared to last week</p>--}}
                            </div>
                            <span class="float-right my-auto mr-auto">
											<i class="mdi mdi-account-multiple" style="font-size: 30px;color: white;"></i>
