    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='order') }}">قائمة الطلبات</a></li>
                </ul>
            </li>
...
{{--                <ul class="slide-menu">--}}
{{--                    <li><a class="slide-item" href="{{ url('/' . $page='bill') }}"> الفواتير</a></li>--}}
{{--                    <li><a class="slide-item" href="{{ url('/' . $page='darggablecards') }}">الزبائن</a></li>--}}
{{--                </ul>--}}
{{--            </li>--}}
